...
namespace hmi
{
    ...
    public:
        ...
        bool press(const std::int32_t x, const std::int32_t y, const std::int32_t track_id,
                   const std::int32_t slot = 0) noexcept;
        bool release(const std::int32_t x, const std::int32_t y, const std::int32_t slot = 0) noexcept;
        bool move(const std::int32_t x, const std::int32_t y, const std::int32_t track_id,
                  const std::int32_t slot = 0) noexcept;
