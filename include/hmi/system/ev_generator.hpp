...
struct event_gen
{
    ...
    static constexpr event_buffer_t<6> touch_press_event(const std::int32_t x, const std::int32_t y, const std::int32_t track_id, const std::int32_t slot) noexcept;
    static constexpr event_buffer_t<5> touch_move_event(const std::int32_t x, const std::int32_t y, const std::int32_t track_id, const std::int32_t slot) noexcept;
    static constexpr event_buffer_t<4> touch_release_event(const std::int32_t x, const std::int32_t y, const std::int32_t slot) noexcept;

private:
    template<std::size_t N, std::size_t M, std::size_t... I, std::size_t... J>
    static constexpr auto concat_buffer_impl(event_buffer_t<N> lhs, event_buffer_t<M> rhs, 
                                             std::index_sequence<I...>, std::index_sequence<J...>) noexcept -> event_buffer_t<N + M>
    {
...
{
    return {{
        {0, 0, ev_type::rel,rel_code::wheel, up_or_down},
        {0, 0, ev_type::sync,sync_code::report, 0}
    }};
}

constexpr event_buffer_t<6> event_gen::touch_press_event(const std::int32_t x, const std::int32_t y, const std::int32_t track_id, const std::int32_t slot) noexcept
{
   event_buffer_t<4> id {{
...
constexpr event_buffer_t<4> event_gen::touch_release_event(const std::int32_t x, const std::int32_t y, const std::int32_t slot) noexcept
{
   event_buffer_t<2> id {{
        {0, 0, ev_type::abs,abs_code::mt_slot, slot},
...
constexpr event_buffer_t<5> event_gen::touch_move_event(const std::int32_t x, const std::int32_t y, const std::int32_t track_id, const std::int32_t slot) noexcept
{
    return {{
        {0, 0, ev_type::abs,abs_code::mt_slot, slot},
        {0, 0, ev_type::abs,abs_code::mt_track_id, track_id},
